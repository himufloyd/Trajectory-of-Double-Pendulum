# Set Path
train_path = '/content/drive/MyDrive/MTP_v2/Soumadip/Data/Train'
val_path = '/content/drive/MyDrive/MTP_v2/Soumadip/Data/Val'
...
if model_name == 'FNN':
    model = DoublePendulum(model_param['hidden_size'], model_param['output_size']).double()
